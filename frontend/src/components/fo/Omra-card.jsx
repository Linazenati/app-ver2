...
export default function OmraCard({ omra }) {
  ...
  const imageSrc = omra.image && omra.image.startsWith("http")
    ...
    : omra.image
      ...
      : '/images/omra1.jpg'; // Image par défaut si rien
        ...
        <div className="col-8">
          <div className="d-flex flex-column h-100 py-3 px-3">
            <div className="w-100">
              ...
              <p className="mb-1 text-muted small fw-semibold">- {omra.description}</p>
              ...
              <p className="mb-2 text-muted small fw-semibold d-flex align-items-center">
                ...
                {omra.duree} jours , {omra.duree - 1} nuits
              </p>
              <a
                href="/web/Infos_omra"
            ...
            <div className="d-flex justify-content-between align-items-center mt-2">
              ...
              <div
                style={{
                  color: '#003366',
                  fontWeight: 'bold',
                  fontSize: '1.5rem', // équivalent à fs-4
                  textAlign: 'center',
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  const omraId = 6; // Ici tu mets ta valeur d'id comme tu veux

                  if (omraId === 6) {
                    window.location.href = '/web/Infos_omra1';
                  } else {
                    window.location.href = '/web/Infos_omra';
                  }
                }}
